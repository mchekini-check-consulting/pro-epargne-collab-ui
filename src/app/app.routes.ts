    ...
    // Admin routes
    {
        ...
        children: [
            ...
            {path: 'features', children: [
                ...
                {path: 'accounts', loadChildren: () => import('app/modules/admin/features/accounts/accounts.routes')},
                {path: 'history', loadChildren: () => import('app/modules/admin/features/history/history.routes')},
